...
interface GenericBaseRowProps {
  item: GenericInterface;
  onEdit: (id: string, item: GenericInterface) => void;
  onDelete: (id: string) => void;
  onActive: (id: string) => void;
}

const GenericBaseRow = ({
  item,
  onEdit,
  onDelete,
  onActive,
  ...
  return (
    <>
      ...
      <tr className="hidden md:table-row hover:bg-gray-50 text-dark">
        ...
        <td className="p-tb whitespace-nowrap text-sm text-center first-letter:capitalize">
          <div className="">{item?.descripcion?.toLowerCase() || ""}</div>
        </td>
